...
export const IconShoppingCart: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const IconRefreshCw: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconRestore: React.FC<{className?: string}> = ({className}) => (
